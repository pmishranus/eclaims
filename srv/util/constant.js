...
const ApplicationConstants = {
    ...
    INCORRECT_FILE_STRUCTURE:
        "Incorrect file structure. Attachments have to be directly uploaded and maintained in the zip.",
...
const MessageConstants = {
    ...
    ERROR: "Error",
    ERROR_DRAFT_EXISTS: 'Draft eclaims data exists already for the provided inputs.'
};
