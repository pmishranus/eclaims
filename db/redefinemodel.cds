...
@cds.persistence.exists
entity PRJ_BASE_ECLAIM_REQUEST_VIEW {
    key DRAFT_ID            : String(15)  @title: 'DRAFT_ID: DRAFT_ID';
     REQUEST_ID          : String(15)  @title: 'REQUEST_ID: REQUEST_ID';
     CLAIM_TYPE          : String(6)   @title: 'CLAIM_TYPE: CLAIM_TYPE';
     STAFF_ID            : String(20)  @title: 'STAFF_ID: STAFF_ID';
     STAFF_NUSNET_ID     : String(100) @title: 'STAFF_NUSNET_ID: STAFF_NUSNET_ID';
     CONCURRENT_STAFF_ID : String(20)  @title: 'CONCURRENT_STAFF_ID: CONCURRENT_STAFF_ID';
     ULU                 : String(15)  @title: 'ULU: ULU';
     FDLU                : String(15)  @title: 'FDLU: FDLU';
     EMPLOYEE_GRP        : String(20)  @title: 'EMPLOYEE_GRP: EMPLOYEE_GRP';
     DATE_JOINED         : String(25)  @title: 'DATE_JOINED: DATE_JOINED';
     EMP_RATE_TYPE       : String(10)  @title: 'EMP_RATE_TYPE: EMP_RATE_TYPE';
     CLAIM_YEAR          : String(4)   @title: 'CLAIM_YEAR: CLAIM_YEAR';
     CLAIM_MONTH         : String(2)   @title: 'CLAIM_MONTH: CLAIM_MONTH';
     REQUEST_STATUS      : String(2)   @title: 'REQUEST_STATUS: REQUEST_STATUS';
     SUBMITTED_ON        : Date        @title: 'SUBMITTED_ON: SUBMITTED_ON';
     SUBMITTED_BY        : String(20)  @title: 'SUBMITTED_BY: SUBMITTED_BY';
     SUBMITTED_BY_NID    : String(100) @title: 'SUBMITTED_BY_NID: SUBMITTED_BY_NID';
     REQUESTOR_GRP       : String(50)  @title: 'REQUESTOR_GRP: REQUESTOR_GRP';
     CREATED_ON          : Timestamp   @title: 'CREATED_ON: CREATED_ON';
     CLAIM_REQUEST_TYPE  : String(10)  @title: 'CLAIM_REQUEST_TYPE: CLAIM_REQUEST_TYPE';
     MODIFIED_BY_NID     : String(100) @title: 'MODIFIED_BY_NID: MODIFIED_BY_NID';
     MODIFIED_ON         : Timestamp   @title: 'MODIFIED_ON: MODIFIED_ON';
     WORKING_HOURS       : String(100) @title: 'WORKING_HOURS: WORKING_HOURS';
     STF_CLAIM_TYPE_CAT  : String(10)  @title: 'STF_CLAIM_TYPE_CAT: STF_CLAIM_TYPE_CAT';
     APPOINTMENT_TRACK   : String(10)  @title: 'APPOINTMENT_TRACK: APPOINTMENT_TRACK';
     CLAIM_TYPE_T        : String(100) @title: 'CLAIM_TYPE_T: CLAIM_TYPE_T';
     STATUS_CODE         : String(2)   @title: 'STATUS_CODE: STATUS_CODE';
     STATUS_TYPE         : String(10)  @title: 'STATUS_TYPE: STATUS_TYPE';
     STATUS_ALIAS        : String(100) @title: 'STATUS_ALIAS: STATUS_ALIAS';
        STATUS_COLOR_CODE   : Integer     @title: 'STATUS_COLOR_CODE: STATUS_COLOR_CODE';
     EMP_GP_C            : String(100) @title: 'EMP_GP_C: EMP_GP_C';
     EMP_GP_T            : String(100) @title: 'EMP_GP_T: EMP_GP_T';
     FDLU_C              : String(100) @title: 'FDLU_C: FDLU_C';
     FULL_NM             : String(256) @title: 'FULL_NM: FULL_NM';
     JOIN_DATE           : Date        @title: 'JOIN_DATE: JOIN_DATE';
     SF_STF_NUMBER       : String(100) @title: 'SF_STF_NUMBER: SF_STF_NUMBER';
};
...
@cds.persistence.exists
entity PRJ_ECLAIM_REQUEST_VIEW {
     CLAIM_MONTH                       : String(2)   @title: 'CLAIM_MONTH: CLAIM_MONTH';
     CLAIM_TYPE                        : String(6)   @title: 'CLAIM_TYPE: CLAIM_TYPE';
     CLAIM_YEAR                        : String(4)   @title: 'CLAIM_YEAR: CLAIM_YEAR';
     CONCURRENT_STAFF_ID               : String(20)  @title: 'CONCURRENT_STAFF_ID: CONCURRENT_STAFF_ID';
    ...
    key DRAFT_ID                          : String(15)  @title: 'DRAFT_ID: DRAFT_ID';
     ...
     SF_STF_NUMBER                     : String(100) @title: 'SF_STF_NUMBER: SF_STF_NUMBER';
     CREATED_ON                        : Timestamp   @title: 'CREATED_ON: CREATED_ON';
     VERIFIER_NUSNET_ID                : String(100) @title: 'VERIFIER_NUSNET_ID: VERIFIER_NUSNET_ID';
     VERIFIER_STAFF_FULL_NAME          : String(100) @title: 'VERIFIER_STAFF_FULL_NAME: VERIFIER_STAFF_FULL_NAME';
     VERIFIER_STAFF_ID                 : String(20)  @title: 'VERIFIER_STAFF_ID: VERIFIER_STAFF_ID';
     VERIFIER_USER_DESIGNATION         : String(20)  @title: 'VERIFIER_USER_DESIGNATION: VERIFIER_USER_DESIGNATION';
     VERIFIER_REFERENCE_ID             : String(15)  @title: 'VERIFIER_REFERENCE_ID: VERIFIER_REFERENCE_ID';
     ADD_APP_1_NUSNET_ID               : String(100) @title: 'ADD_APP_1_NUSNET_ID: ADD_APP_1_NUSNET_ID';
     ADD_APP_1_REFERENCE_ID            : String(15)  @title: 'ADD_APP_1_REFERENCE_ID: ADD_APP_1_REFERENCE_ID';
     ADD_APP_1_STAFF_FULL_NAME         : String(100) @title: 'ADD_APP_1_STAFF_FULL_NAME: ADD_APP_1_STAFF_FULL_NAME';
     ADD_APP_1_STAFF_ID                : String(20)  @title: 'ADD_APP_1_STAFF_ID: ADD_APP_1_STAFF_ID';
     ADD_APP_1_USER_DESIGNATION        : String(20)  @title: 'ADD_APP_1_USER_DESIGNATION: ADD_APP_1_USER_DESIGNATION';
     ADDITIONAL_APP_2_NUSNET_ID        : String(100) @title: 'ADDITIONAL_APP_2_NUSNET_ID: ADDITIONAL_APP_2_NUSNET_ID';
     ADDITIONAL_APP_2_REFERENCE_ID     : String(15)  @title: 'ADDITIONAL_APP_2_REFERENCE_ID: ADDITIONAL_APP_2_REFERENCE_ID';
     ADDITIONAL_APP_2_STAFF_FULL_NAME  : String(100) @title: 'ADDITIONAL_APP_2_STAFF_FULL_NAME: ADDITIONAL_APP_2_STAFF_FULL_NAME';
     ADDITIONAL_APP_2_STAFF_ID         : String(20)  @title: 'ADDITIONAL_APP_2_STAFF_ID: ADDITIONAL_APP_2_STAFF_ID';
     ADDITIONAL_APP_2_USER_DESIGNATION : String(20)  @title: 'ADDITIONAL_APP_2_USER_DESIGNATION: ADDITIONAL_APP_2_USER_DESIGNATION';
     CLAIM_REQUEST_TYPE                : String(10)  @title: 'CLAIM_REQUEST_TYPE: CLAIM_REQUEST_TYPE';
     PROCESS_CODE                      : String(6)   @title: 'PROCESS_CODE: PROCESS_CODE';
     PROCESS_STATUS                    : String(2)   @title: 'PROCESS_STATUS: PROCESS_STATUS';
     PROCESS_INST_ID                   : String(12)  @title: 'PROCESS_INST_ID: PROCESS_INST_ID';
     IS_LOCKED                         : String(2)   @title: 'IS_LOCKED: IS_LOCKED';
     LOCKED_BY_USER_NID                : String(100) @title: 'LOCKED_BY_USER_NID: LOCKED_BY_USER_NID';
     LOCKED_STAFF_USER_GRP             : String(50)  @title: 'LOCKED_STAFF_USER_GRP: LOCKED_STAFF_USER_GRP';
     VERIFIER_PPNT_ID                  : String(15)  @title: 'VERIFIER_PPNT_ID: VERIFIER_PPNT_ID';
     ADDITIONAL_APP_2_PPNT_ID          : String(15)  @title: 'ADDITIONAL_APP_2_PPNT_ID: ADDITIONAL_APP_2_PPNT_ID';
     ADD_APP_1_PPNT_ID                 : String(15)  @title: 'ADD_APP_1_PPNT_ID: ADD_APP_1_PPNT_ID';
        MODIFIED_ON                       : Timestamp   @title: 'MODIFIED_ON: MODIFIED_ON';
     MODIFIED_BY_NID                   : String(100) @title: 'MODIFIED_BY_NID: MODIFIED_BY_NID';
     FDLU_T                            : String(100) @title: 'FDLU_T: FDLU_T';
     ULU_T                             : String(100) @title: 'ULU_T: ULU_T';
     LOCKED_USER_FULL_NM               : String(256) @title: 'LOCKED_USER_FULL_NM: LOCKED_USER_FULL_NM';
     WORKING_HOURS                     : String(100) @title: 'WORKING_HOURS: WORKING_HOURS';
     STF_CLAIM_TYPE_CAT                : String(10)  @title: 'STF_CLAIM_TYPE_CAT: STF_CLAIM_TYPE_CAT';
        PROCESS_ACTUAL_DOC                : Date        @title: 'PROCESS_ACTUAL_DOC: PROCESS_ACTUAL_DOC';
     APPOINTMENT_TRACK                 : String(10)  @title: 'APPOINTMENT_TRACK: APPOINTMENT_TRACK';
     PROCESS_STATUS_ALIAS              : String(100) @title: 'PROCESS_STATUS_ALIAS: PROCESS_STATUS_ALIAS';
...
@cds.persistence.exists
entity PRJ_TASK_ACTION_CONFIG {
        CC_1            : Integer64  @title: 'CC_1: CC_1';
    key TASK_INST_ID    : String(12) @title: 'TASK_INST_ID: TASK_INST_ID';
        TASK_NAME       : String(40) @title: 'TASK_NAME: TASK_NAME';
        TASK_ASSGN_GRP  : String(40) @title: 'TASK_ASSGN_GRP: TASK_ASSGN_GRP';
        PROCESS_INST_ID : String(12) @title: 'PROCESS_INST_ID: PROCESS_INST_ID';
        TASK_STATUS     : String(2)  @title: 'TASK_STATUS: TASK_STATUS';
        ACTION_NAME     : String(50) @title: 'ACTION_NAME: ACTION_NAME';
        REQUESTOR_GRP   : String(50) @title: 'REQUESTOR_GRP: REQUESTOR_GRP';
        BUTTON_TYPE     : String(20) @title: 'BUTTON_TYPE: BUTTON_TYPE';
        DISPLAY_ICON    : String(40) @title: 'DISPLAY_ICON: DISPLAY_ICON';
        SEQUENCE_ORDER  : Integer    @title: 'SEQUENCE_ORDER: SEQUENCE_ORDER';
